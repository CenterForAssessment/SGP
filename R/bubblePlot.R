...
grid.text(x=0.5, y=y.coors-0.03, paste("Correlation (N \u2265 10):", round(cor(bubble_plot_data.X[bubble_plot_data.SIZE>=10], bubble_plot_data.Y[bubble_plot_data.SIZE>=10], use="complete.obs"), digits=2)))
