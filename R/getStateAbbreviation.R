...
function(
	...
	my.state.abbreviations <- c(state.abb, "AOB", rep("DEMO", 2), "GUA") ### NOTE: Add abbreviations ALPHABETICALLY
	my.state.names <- c(state.name, "AOB", "DEMONSTRATION", "SGPDATA LONG", "GUATEMALA") ### NOTE: Add state names ALPHABETICAALY
