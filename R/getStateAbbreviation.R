...
function(
	...
	my.state.abbreviations <- c(state.abb, "ABQ", "AOB", rep("DEMO", 2), "GUA", "RLI", "WIDA_CO", "WIDA_MA", "WIDA") ### NOTE: Add abbreviations ALPHABETICALLY
	my.state.names <- c(state.name, "ALBUQUERQUE", "AOB", "DEMONSTRATION", "SGPDATA LONG", "GUATEMALA", "RLI", "WIDA CO", "WIDA MA", "WIDA") ### NOTE: Add state names ALPHABETICALLY - need compound abbreviations/names first (e.g. WIDA_CO before WIDA)
