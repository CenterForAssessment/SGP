...
function(
	...
	my.state.names <- c(setdiff(datasets::state.name, c("Massachusetts", "Washington")), "Albuquerque", "AOB", "ATI", "Bureau_Indian_Affairs", "Colorado", "Washington DC", "Department_of_Defense", "Demonstration", "SGPDATA LONG", "Demonstration COVID", "SGPDATA LONG COVID", "Demonstration", "Gwinnett", "Guatemala", "Massachusetts MCAS", "Massachusetts PARCC", "Massachusetts", "Massachusetts", "NCSC SD", "New Jersey", "PARCC", "Rhode Island", "RLI UK", "RLI", "SBAC", "US Virgin Islands", "WIDA CO", "WIDA DPS", "WIDA GA", "WIDA IN", "WIDA MA", "WIDA MI", "WIDA NH", "WIDA NV", "WIDA RI", "WIDA WI", "WIDA", "Washington") ### NOTE: Add abbreviations (not states) names ALPHABETICALLY - need compound abbreviations first (e.g. WIDA_CO before WIDA)
