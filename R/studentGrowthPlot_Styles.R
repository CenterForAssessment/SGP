...
if (reports.by.school) {
	...
	## Start pdf device
		...
		pushViewport(get(paste("content_area_", vp, ".vp", sep="")))
				...
				Scale_Score_Targets_CUKU=list(NY1=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_3_YEAR_PROJ_YEAR_1")),
								NY2=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_3_YEAR_PROJ_YEAR_3")),
								NY3=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_3_YEAR_PROJ_YEAR_3"))),
				Scale_Score_Targets_MUSU=list(NY1=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_MOVE_UP_STAY_UP_3_YEAR_PROJ_YEAR_1")),
								NY2=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_MOVE_UP_STAY_UP_3_YEAR_PROJ_YEAR_3")),
								NY3=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_MOVE_UP_STAY_UP_3_YEAR_PROJ_YEAR_3"))),
				Scale_Score_Targets_Current_CUKU=list(NY1=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_3_YEAR_PROJ_YEAR_1_CURRENT")),
								NY2=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_3_YEAR_PROJ_YEAR_3_CURRENT")),
								NY3=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_3_YEAR_PROJ_YEAR_3_CURRENT"))),
				Scale_Score_Targets_Current_MUSU=list(NY1=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_MOVE_UP_STAY_UP_3_YEAR_PROJ_YEAR_1_CURRENT")),
								NY2=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_MOVE_UP_STAY_UP_3_YEAR_PROJ_YEAR_3_CURRENT")),
								NY3=as.numeric(subset(tmp_student_data, select="SCALE_SCORE_SGP_TARGET_MOVE_UP_STAY_UP_3_YEAR_PROJ_YEAR_3_CURRENT"))),
