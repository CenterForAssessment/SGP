...
As a package built for the [**R** software environment](https://www.r-project.org/), to use the **SGP** one needs a computer with **R** installed. **R** is available
...
**R**. If you're new to **R**, you might want to spend some time familiarizing yourself with it before diving into running **SGP** analyses.
...
(e.g., [RStudio](https://www.rstudio.com/)), the installed **R** client, or calling **R** from the command line. In all cases, packages can be installed
