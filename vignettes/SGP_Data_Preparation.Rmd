...
models the format for data used with the lower level [`studentGrowthPercentiles`](../reference/studentGrowthPercentiles.html) and
[`studentGrowthProjections`](../reference/studentGrowthProjections.html) functions.
...
[`abcSGP`](../reference/abcSGP.html), [`prepareSGP`](../reference/prepareSGP.html),
[`analyzeSGP`](../reference/analyzeSGP.html), [`combineSGP`](../reference/combineSGP.html),
[`summarizeSGP`](../reference/summarizeSGP.html), [`visualizeSGP`](../reference/visualizeSGP.html), and  [`outputSGP`](../reference/outputSGP.html)
...
in the embedded [SGPstateData](https://github.com/CenterForAssessment/SGPstateData) meta-data. See the SGP package documentation](../reference/index.html) for more
...
[`summarizeSGP`](../reference/summarizeSGP.html) function.
